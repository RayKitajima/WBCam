...
@implementation DeviceConfig_iPhone4_iOS7

- (id)init
{
    self = [super init];
    
    applicationMode = @"iphone3,* iOS7";
    deviceIdentification = kDeviceIdentification_iPhone4_iOS7;
    ...
    // stillimage
    stillimageWidth  = 1936;
    stillimageHeight = 2592;
    stillimageSize   = (2592*1936*4);
    stillimagePixels = (2592*1936);
