...
const CGFloat mf_gear_button_off_alpha      = 0.50f;
const CGFloat mf_gear_button_off_bg_alpha   = 0.45f;
const CGFloat mf_gear_button_off_line_alpha = 0.45f;

const CGFloat mf_gear_button_on_alpha       = 0.75f;
const CGFloat mf_gear_button_on_bg_alpha    = 0.70f;
const CGFloat mf_gear_button_on_line_alpha  = 0.70f;

@implementation GearMFButton
...
- (void) buttonOn
{
	...
	[layer setBackgroundColor:[[UIColor colorWithWhite:0.3f alpha:mf_gear_button_on_bg_alpha] CGColor]];
	[layer setBorderColor:[[UIColor colorWithWhite:1.0f alpha:mf_gear_button_on_line_alpha] CGColor]];
	
	GearContainer *container = [GearContainer quickInstance];
	[container showAlignmentMF]; // on
}
...
- (void) buttonOff
{
	...
	CALayer *layer = [self layer];
	[layer setBackgroundColor:[[UIColor colorWithWhite:0.3f alpha:mf_gear_button_off_bg_alpha] CGColor]];
	[layer setBorderColor:[[UIColor colorWithWhite:1.0f alpha:mf_gear_button_off_line_alpha] CGColor]];
	
	GearContainer *container = [GearContainer quickInstance];
	[container hideAlignmentMF]; // off
}
#pragma mark
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    gear_btn_mark_view = [[GearColorMark alloc] initWithFrame:CGRectMake(7, 10, 10, 10) withCGColorRef:[UIColor greenColor].CGColor];
    gear_btn_mark_view.layer.opacity = mf_gear_button_off_alpha;
	...
	btnLabel.layer.opacity = mf_gear_button_off_alpha;
    btnLabel.hidden = NO;
