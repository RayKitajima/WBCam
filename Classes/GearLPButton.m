...
const CGFloat lp_gear_button_off_alpha      = 0.50f;
const CGFloat lp_gear_button_off_bg_alpha   = 0.45f;
const CGFloat lp_gear_button_off_line_alpha = 0.45f;

const CGFloat lp_gear_button_on_alpha       = 0.75f;
const CGFloat lp_gear_button_on_bg_alpha    = 0.70f;
const CGFloat lp_gear_button_on_line_alpha  = 0.70f;

@implementation GearLPButton
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    gear_btn_mark_view = [[GearColorMark alloc] initWithFrame:CGRectMake(7, 10, 10, 10) withCGColorRef:[UIColor whiteColor].CGColor];
    gear_btn_mark_view.layer.opacity = lp_gear_button_off_alpha;
	gear_btn_mark_view.hidden = NO;
    [self addSubview:gear_btn_mark_view];
    
    CALayer *layer = [self layer];
    [layer setBackgroundColor:[[UIColor colorWithWhite:0.3f alpha:lp_gear_button_off_bg_alpha] CGColor]];
    [layer setBorderWidth:1.0f];
    [layer setBorderColor:[[UIColor colorWithWhite:1.0f alpha:lp_gear_button_off_line_alpha] CGColor]];
	...
	btnLabel.layer.opacity = lp_gear_button_off_alpha;
    btnLabel.hidden = NO;
